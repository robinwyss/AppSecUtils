...
namespace Dynatrace.API.Model
{
        ...
        public partial class AuditLog :  IEquatable<AuditLog>, IValidatableObject
    {
        ...
        /// <param name="auditLogs">A list of audit log entries ordered by the creation timestamp..</param>
        public AuditLog(long? totalCount = default(long?), int? pageSize = default(int?), string nextPageKey = default(string), List<AuditLogEntry> auditLogs = default(List<AuditLogEntry>))
        {
            // to ensure "totalCount" is required (not null)
            if (totalCount == null)
            {
                throw new InvalidDataException("totalCount is a required property for AuditLog and cannot be null");
            }
            else
            {
        ...
        /// </summary>
        /// <value>A list of audit log entries ordered by the creation timestamp.</value>
