...
namespace Dynatrace.API.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class ExtensionMonitoringConfigurationsList :  IEquatable<ExtensionMonitoringConfigurationsList>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ExtensionMonitoringConfigurationsList" /> class.
        /// </summary>
        /// <param name="items">A list of extension monitoring configurations..</param>
        ...
        public ExtensionMonitoringConfigurationsList(List<ExtensionMonitoringConfiguration> items = default(List<ExtensionMonitoringConfiguration>), long? totalCount = default(long?), int? pageSize = default(int?), string nextPageKey = default(string))
        {
            // to ensure "totalCount" is required (not null)
            if (totalCount == null)
            {
                throw new InvalidDataException("totalCount is a required property for ExtensionMonitoringConfigurationsList and cannot be null");
            }
            else
            {
        ...
        /// </summary>
        /// <value>A list of extension monitoring configurations.</value>
        [DataMember(Name="items", EmitDefaultValue=false)]
        public List<ExtensionMonitoringConfiguration> Items { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ExtensionMonitoringConfigurationsList {\n");
        ...
        {
            return this.Equals(input as ExtensionMonitoringConfigurationsList);
        }

        /// <summary>
        /// Returns true if ExtensionMonitoringConfigurationsList instances are equal
        /// </summary>
        /// <param name="input">Instance of ExtensionMonitoringConfigurationsList to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ExtensionMonitoringConfigurationsList input)
        {
            if (input == null)
                return false;
