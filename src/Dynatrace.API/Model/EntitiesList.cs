...
namespace Dynatrace.API.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class EntitiesList :  IEquatable<EntitiesList>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EntitiesList" /> class.
        /// </summary>
        ...
        /// <param name="entities">A list of monitored entities..</param>
        public EntitiesList(long? totalCount = default(long?), int? pageSize = default(int?), string nextPageKey = default(string), List<Entity> entities = default(List<Entity>))
        {
            // to ensure "totalCount" is required (not null)
            if (totalCount == null)
            {
                throw new InvalidDataException("totalCount is a required property for EntitiesList and cannot be null");
            }
            else
            {
        ...
        /// </summary>
        /// <value>A list of monitored entities.</value>
        ...
        {
            return this.Equals(input as EntitiesList);
        }

        /// <summary>
        /// Returns true if EntitiesList instances are equal
        /// </summary>
        /// <param name="input">Instance of EntitiesList to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EntitiesList input)
        {
            if (input == null)
                return false;
