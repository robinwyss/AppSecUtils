...
namespace Dynatrace.API.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class EntityTypeList :  IEquatable<EntityTypeList>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EntityTypeList" /> class.
        /// </summary>
        ...
        public EntityTypeList(long? totalCount = default(long?), int? pageSize = default(int?), string nextPageKey = default(string), List<EntityType> types = default(List<EntityType>))
        {
            ...
            if (totalCount == null)
            {
                throw new InvalidDataException("totalCount is a required property for EntityTypeList and cannot be null");
            }
            else
            {
        ...
        /// </summary>
        /// <value>The list of meta information for all available entity-types</value>
        [DataMember(Name="types", EmitDefaultValue=false)]
        public List<EntityType> Types { get; set; }
        ...
        {
            return this.Equals(input as EntityTypeList);
        }

        /// <summary>
        /// Returns true if EntityTypeList instances are equal
        /// </summary>
        /// <param name="input">Instance of EntityTypeList to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EntityTypeList input)
        {
            if (input == null)
                return false;
