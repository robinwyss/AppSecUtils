...
namespace Dynatrace.API.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class ObjectsList :  IEquatable<ObjectsList>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ObjectsList" /> class.
        /// </summary>
        /// <param name="items">A list of settings objects..</param>
        ...
        public ObjectsList(List<SettingsObject> items = default(List<SettingsObject>), string nextPageKey = default(string), int? pageSize = default(int?), long? totalCount = default(long?))
        {
            // to ensure "totalCount" is required (not null)
            if (totalCount == null)
            {
                throw new InvalidDataException("totalCount is a required property for ObjectsList and cannot be null");
            }
            else
            {
        ...
        /// A list of settings objects.
        /// </summary>
        /// <value>A list of settings objects.</value>
        [DataMember(Name="items", EmitDefaultValue=false)]
        public List<SettingsObject> Items { get; set; }
        ...
        {
            return this.Equals(input as ObjectsList);
        }

        /// <summary>
        /// Returns true if ObjectsList instances are equal
        /// </summary>
        /// <param name="input">Instance of ObjectsList to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ObjectsList input)
        {
            if (input == null)
                return false;
