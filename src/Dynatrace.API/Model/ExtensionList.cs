...
namespace Dynatrace.API.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class ExtensionList :  IEquatable<ExtensionList>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ExtensionList" /> class.
        /// </summary>
        /// <param name="extensions">A list of extensions..</param>
        ...
        public ExtensionList(List<MinimalExtension> extensions = default(List<MinimalExtension>), long? totalCount = default(long?), int? pageSize = default(int?), string nextPageKey = default(string))
        {
            // to ensure "totalCount" is required (not null)
            if (totalCount == null)
            {
                throw new InvalidDataException("totalCount is a required property for ExtensionList and cannot be null");
            }
            else
            {
        ...
        /// </summary>
        /// <value>A list of extensions.</value>
        [DataMember(Name="extensions", EmitDefaultValue=false)]
        public List<MinimalExtension> Extensions { get; set; }
        ...
        {
            return this.Equals(input as ExtensionList);
        }

        /// <summary>
        /// Returns true if ExtensionList instances are equal
        /// </summary>
        /// <param name="input">Instance of ExtensionList to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ExtensionList input)
        {
            if (input == null)
                return false;
